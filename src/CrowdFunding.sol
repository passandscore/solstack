...
contract CrowdFunding {
    ...
    /*
     * @dev Get the details of a campaign
    ...
    /*
     * @dev Get the pledged amount of a pledger
     * @param campaignId The id of the campaign
     * @param pledger The address of the pledger
     * @return The pledged amount of the pledger
     */
    ...
    /// @dev Checks if the campaign has not started
